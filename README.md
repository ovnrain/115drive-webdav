...
[![GitHub Actions](https://img.shields.io/github/actions/workflow/status/ovnrain/115drive-webdav/ci.yml?branch=main)](https://github.com/ovnrain/115drive-webdav/actions)
[![Release](https://img.shields.io/github/v/release/ovnrain/115drive-webdav?display_name=tag)](https://github.com/ovnrain/115drive-webdav/releases)
[![Downloads](https://img.shields.io/github/downloads/ovnrain/115drive-webdav/total)](https://github.com/ovnrain/115drive-webdav/releases)
[![Docker Image](https://img.shields.io/docker/pulls/ovnrain/115drive-webdav)](https://hub.docker.com/r/ovnrain/115drive-webdav)
...
## 下载
https://github.com/ovnrain/115drive-webdav/releases
...
docker run -d \
	...
	--restart unless-stopped \
        ovnrain/115drive-webdav:latest \
...
--files-cache-ttl
    目录列表缓存时间（秒），默认 120（2 分钟）；设为 0 可关闭缓存。
    在 115 端新增文件后，WebDAV 客户端最长等待该时间后即可刷新看到新文件。
    若希望刷新更快看到新文件，可适当调小或设为 0。
